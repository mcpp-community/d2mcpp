...
// license: Apache-2.0
// file: src/en/cpp11/tests/14-type-alias/2.cpp
//
...
int main() {
    ...
    d2x::check_eq(numbers[0], 1, "numbers[0] == 1");
    d2x::check_eq(numbers[1], 2, "numbers[1] == 2");
    d2x::check_eq(numbers[2], 3, "numbers[2] == 3");

    d2x::check_eq(v3[0], 1.0f, "v3[0] == 1.0f");
    d2x::check_eq(v3[1], 2.0f, "v3[1] == 2.0f");
    d2x::check_eq(v3[2], 3.0f, "v3[2] == 3.0f");
