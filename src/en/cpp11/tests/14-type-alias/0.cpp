...
// license: Apache-2.0
// file: src/en/cpp11/tests/14-type-alias/0.cpp
//
...
int main() {
    ...
    bool ok = std::is_same<Integer, int>::value; d2x::check(ok, "ok");
    ok = std::is_same<Real, double>::value; d2x::check(ok, "ok");
