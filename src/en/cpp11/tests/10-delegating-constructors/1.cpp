...
// license: Apache-2.0
// file: src/en/cpp11/tests/10-delegating-constructors/1.cpp
//
...
int main() { // Do not modify the code in the main function
    ...
    d2x::check(a1.get_id() == "1111", "a1.get_id() == \"1111\"");

    Object::construction_counter = 0;
    Account a2 { "2222",  "d2learn", 100 };
    std::cout << a2.to_string() << std::endl;

    d2x::check(a2.get_object_name() == "d2learn", "a2.get_object_name() == \"d2learn\"");
    d2x::check_eq(Object::construction_counter, 1, "Object::construction_counter == 1");
