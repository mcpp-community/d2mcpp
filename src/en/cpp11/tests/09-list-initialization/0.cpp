...
// license: Apache-2.0
// file: src/en/cpp11/tests/09-list-initialization/0.cpp
//
...
int main() {
    ...
    int a1 = 1.1;
    d2x::check_eq(a1, 1, "a1 == 1");

    int a2 = 1.1;
    int a3 = { 1.1 };
    d2x::check_eq(a2, 1, "a2 == 1");
    d2x::check_eq(a3, 1, "a3 == 1");
    ...
    d2x::check_eq(b2, 1, "b2 == 1");
    d2x::check_eq(c2, 2, "c2 == 2");

    int arr1[] = { 1, 2.2, 3 };
    d2x::check_eq(arr1[1], 2, "arr1[1] == 2");

    int arr2[4] { 1, b1, c1 };
    d2x::check_eq(arr2[1], 1, "arr2[1] == 1");
    d2x::check_eq(arr2[2], 2, "arr2[2] == 2");
    d2x::check_eq(arr2[3], 0, "arr2[3] == 0");
