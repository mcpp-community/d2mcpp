...
// license: Apache-2.0
// file: dslings/en/cpp14/02-variable-templates-1.cpp
//
// Exercise: cpp14 | 02 - variable templates | _v type traits
//
// Tips:
// - _v-suffixed type traits are variable templates that save the ::value access
